...
def reward(taskIndex, plannerCurrNo, plannerCurrTime, plannerCurrPrevConsecutiveTime,  time_left_episode, df):
    ...
    if missingTime > time_left_episode:
        ...
        if missingTime <= 0:
            ...
            # Patrick: the reward should speak about the best possible planner
            # R_s = (1 - (plannerCurrConsecutiveTime - minTimeReq_currPlanner) / (time_per_ep - minTimeReq_currPlanner)) * Theta
        else:
            R_p = 0
            R_s = 0
