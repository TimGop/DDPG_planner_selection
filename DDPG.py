...
class DDPG(object):
    def __init__(self, gamma, tau, h, w, num_planners, env):
        ...
        self.actor_optimizer = Adam(self.actor.parameters(), lr=2e-3)  # optimizer for actor net
        self.critic_optimizer = Adam(self.critic.parameters(), lr=2e-3)  # optimizer for critic net
