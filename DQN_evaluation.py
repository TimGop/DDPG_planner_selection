...
class evaluation:
    ...
    def evaluateNetwork(self, episodeNumbers, averageRewards, currentEpisodeNumber, discrete_agent,
        ...
        for task_i_idx in range(num_of_tests):
            ...
            while not final_state and not time_restriction:
                ...
                obs, reward, final_state, time_restriction, _ = self.env.step(complete_action)
                print(final_state)
